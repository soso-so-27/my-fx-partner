                            ...
                            <Card key={trade.id}>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-base font-medium font-numbers flex items-center gap-2">
                                        ...
                                        {trade.isVerified && (
                                            <Badge variant="secondary" className="bg-blue-500/10 text-blue-500 hover:bg-blue-500/20 border-blue-500/20 gap-1 h-5 px-1.5">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Badge variant={trade.pnl && trade.pnl > 0 ? "default" : "destructive"} className={trade.pnl && trade.pnl > 0 ? "bg-profit hover:bg-profit/80" : "bg-loss hover:bg-loss/80"}>
                                            <span className="font-numbers">{trade.pnl ? `${trade.pnl > 0 ? '+' : ''}${trade.pnl}` : '決済待ち'}</span>
                                        </Badge>
                                    </div>
                                </CardHeader>
                                <CardContent>
