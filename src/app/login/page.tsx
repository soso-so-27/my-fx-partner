    ...
    if (status === "loading") {
        return (
            <div className="min-h-screen flex items-center justify-center bg-background">
                <Loader2 className="h-8 w-8 animate-spin text-solo-gold" />
            </div>
        )
    }
            ...
            <div className="min-h-screen flex items-center justify-center p-4 bg-background">
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>ログイン済み</CardDescription>
                    </CardHeader>
            ...
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-4">
                    <Button
                        ...
                        className="w-full bg-solo-gold hover:bg-solo-gold/90 text-solo-black font-medium flex items-center justify-center gap-2"
                    >
